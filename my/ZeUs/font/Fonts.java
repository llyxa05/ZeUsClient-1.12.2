...
public class Fonts {
    ...
    public static CFontRenderer arial = new CFontRenderer(getFontTTF("arial", 15), true, true);
    
    public static CFontRenderer NotoSansSemiCondensedLightItalic_12 = new CFontRenderer(getFontTTF("NotoSansSemiCondensedLightItalic", 12), true, true);
    public static CFontRenderer NotoSansSemiCondensedLightItalic_13 = new CFontRenderer(getFontTTF("NotoSansSemiCondensedLightItalic", 13), true, true);
    public static CFontRenderer NotoSansSemiCondensedLightItalic_14 = new CFontRenderer(getFontTTF("NotoSansSemiCondensedLightItalic", 14), true, true);
