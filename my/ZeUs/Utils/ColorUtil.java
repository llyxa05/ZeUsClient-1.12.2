...
public class ColorUtil
{
	public static int getRainbow() {
		return rainbow(10000L, 1f).getRGB();
	}
    ...
    public static int getRainbow1(float seconds, float saturation, float brightness) {
    	float hue = (System.currentTimeMillis() % (int) (seconds * 10000)) / (float)(seconds * 1000);
    	int color = Color.HSBtoRGB(hue, saturation, brightness);
    	return color;
    }
    public static int getRainbow1(float seconds, float saturation, float brightness, long index) {
    	float hue = ((System.currentTimeMillis() + index) % (int) (seconds * 10000)) / (float)(seconds * 1000);
    	int color = Color.HSBtoRGB(hue, saturation, brightness);
    	return color;
    }
