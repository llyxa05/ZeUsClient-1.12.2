...
import my.ZeUs.commands.CommandHandler;
import my.ZeUs.modules.hack.Misc.ChatBypass;
...
import shwepss.event.EventTick;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
     ...
     */
    public void sendChatMessage(String message) throws UnknownHostException, IOException
    {
    	
        my.ZeUs.commands.CommandHandler handler = new my.ZeUs.commands.CommandHandler();
        ...
        if(ChatBypass.ivan) {
        	if(!message.startsWith("/")) {
        		if(Client.settingsManager.getSettingByName("RU UTF Font ").getValBoolean()) {
                    ...
                    message = message.replaceAll("у", "y");
                }
            	if(Client.settingsManager.getSettingByName("ENG UTF Font ").getValBoolean()) {
