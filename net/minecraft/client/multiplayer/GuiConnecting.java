        ...
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet())
        {
            public void run()
            {
                ...
                try
                {
                    ...
                    if(Client.settingsManager.getSettingByName("Protect IP ").getValBoolean()) {
                    	my.ZeUs.Utils.Client.getInstance().getDiscordRP().update("Playing on: PROTECTED", "In Game"); 
                    } else {
                    	my.ZeUs.Utils.Client.getInstance().getDiscordRP().update("Playing on: " + ip + (port != 25565 ? ":" + port : ""), "In Game"); 
                    }
                 }
