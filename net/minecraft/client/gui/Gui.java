...
public class Gui
{
    ...
    public static void drawRect(double x, double offset, double e, double d, int color)
    {
        if (x < e)
        {
        	double i = x;
        ...
        bufferbuilder.pos((double)x, (double)d, 0.0D).endVertex();
        bufferbuilder.pos((double)e, (double)d, 0.0D).endVertex();
        bufferbuilder.pos((double)e, (double)offset, 0.0D).endVertex();
        bufferbuilder.pos((double)x, (double)offset, 0.0D).endVertex();
        tessellator.draw();
     ...
     */
    public static void drawModalRectWithCustomSizedTexture(double d, double e, float u, float v, double width, double height, float textureWidth, float textureHeight)
    {
        ...
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
        bufferbuilder.pos((double)d, (double)(e + height), 0.0D).tex((double)(u * f), (double)((v + (float)height) * f1)).endVertex();
        bufferbuilder.pos((double)(d + width), (double)(e + height), 0.0D).tex((double)((u + (float)width) * f), (double)((v + (float)height) * f1)).endVertex();
        bufferbuilder.pos((double)(d + width), (double)e, 0.0D).tex((double)((u + (float)width) * f), (double)(v * f1)).endVertex();
        bufferbuilder.pos((double)d, (double)e, 0.0D).tex((double)(u * f), (double)(v * f1)).endVertex();
        tessellator.draw();
    }
