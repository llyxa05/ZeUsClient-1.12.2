...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        CFontRenderer fr12 = Fonts.NotoSansSemiCondensedLightItalic_12;
        CFontRenderer fr13 = Fonts.NotoSansSemiCondensedLightItalic_13;
        CFontRenderer fr14 = Fonts.NotoSansSemiCondensedLightItalic_14;
        GlStateManager.enableBlend();
        
        String mode = Client.settingsManager.getSettingByName("Style Selection").getValString();
        
        //watermarka
        if(WaterMark.whater) {
        	if(mode.equalsIgnoreCase("Animate")) {
                String str = ChatUtils.purple + ChatUtils.l + ChatUtils.n + "ZeUs" + ChatUtils.o + "Hack";
                String kek = make2(str);
                GL11.glEnable(GL11.GL_BLEND);
                this.drawString(fontrenderer, kek, 2, 1, 0xffffffff); 
        	}                
        }
        if(WaterMark.whater) {
        	if(mode.equalsIgnoreCase("Static")) {
        		GL11.glEnable(GL11.GL_BLEND);
                this.drawString(fontrenderer, ChatUtils.purple + ChatUtils.l + ChatUtils.n + "ZeUs", 2, 1, 0xffffffff);  
            }
        }
        if(WaterMark.whater) {
        	if(mode.equalsIgnoreCase("OneTap")) {
        		...
        		GL11.glEnable(GL11.GL_BLEND);
        		Gui.drawRect(2.0f, 4.0f, fr12.getStringWidth("zeushack.su | "  + mc.player.getName() + " | " + date.getHours() + ":" + date.getMinutes() + ":" + date.getSeconds()) + 12, 1.5f, new Color(80, 20, 80, 255).getRGB());
        		Gui.drawRect(2.0f, 4.0f, fr12.getStringWidth("zeushack.su | "  + mc.player.getName() + " | " + date.getHours() + ":" + date.getMinutes() + ":" + date.getSeconds()) + 12, 12.0f, new Color(40, 40, 40, 255).getRGB());
        		RectHelper.drawGlow(3.0f, 0f, fr12.getStringWidth("zeushack.su | "  + mc.player.getName() + " | " + date.getHours() + ":" + date.getMinutes() + ":" + date.getSeconds()) + 11, 18.0f, new Color(40, 40, 40, 255).getRGB());
        		//RectHelper.drawGlow(3f, 0f, 101, 10f, new Color(80, 30, 80, 255).getRGB());
        		fr12.drawString(ChatUtils.purple + ChatUtils.l + "zeushack.su | "  + mc.player.getName() + " | " + date.getHours() + ":" + date.getMinutes() + ":" + date.getSeconds(), 4, 6.5, 0xffffffff);
            }
        }
        
        //hud
        if(InfoBoard.infoboard) {
        	GL11.glEnable(GL11.GL_BLEND);
        	Gui.drawRect(2f, 65f, 80f, 16f, new Color(40, 40, 40, 255).getRGB());
        	fr13.drawString(ChatUtils.purple + ChatUtils.l + "INFO", 32, 20, 0xffffffff);
            Gui.drawRect(5f, 28f, 75, 26f, new Color(80, 30, 80, 255).getRGB());
        	//RectHelper.drawGlow(6f, 22f, 75, 31f, new Color(80, 30, 80, 255).getRGB());
        	if(mc.isSingleplayer()) {
        		GL11.glEnable(GL11.GL_BLEND);
        		fr14.drawString(ChatUtils.purple + ChatUtils.l + "IP: Singleplayer", 4, 31, 0xffffffff);
        	} else {
        		GL11.glEnable(GL11.GL_BLEND);
            	fr14.drawString(ChatUtils.purple + ChatUtils.l + "IP: " + mc.getCurrentServerData().serverIP, 4, 31, 0xffffffff);
        	}
            fr14.drawString(ChatUtils.purple + ChatUtils.l + "FPS: " + Minecraft.debugFPS, 4, 38, 0xffffffff);
            fr14.drawString(ChatUtils.purple + ChatUtils.l + "X: " + Wrapper.getPlayer().getPosition().getX(), 4, 44, 0xffffffff);
            fr14.drawString(ChatUtils.purple + ChatUtils.l + "Y: " + Wrapper.getPlayer().getPosition().getY(), 4, 51, 0xffffffff);
            fr14.drawString(ChatUtils.purple + ChatUtils.l + "Z: " + Wrapper.getPlayer().getPosition().getZ(), 4, 58, 0xffffffff);
            //RectHelper.drawGlow(3f, 0f, 101, 10f, new Color(80, 30, 80, 255).getRGB());
            //RectHelper.drawGlow(3f, 60f, 79, 70f, new Color(80, 30, 80, 255).getRGB());
        }
