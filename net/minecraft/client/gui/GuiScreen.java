...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
     ...
     */
    public boolean handleComponentClick(ITextComponent component) throws UnknownHostException, IOException
    {
        if (component == null)
        {
            return false;
     ...
     * @throws UnknownHostException 
     */
    public void sendChatMessage(String msg) throws UnknownHostException, IOException
    {
        this.sendChatMessage(msg, true);
    }

    public void sendChatMessage(String msg, boolean addToChat) throws UnknownHostException, IOException
    {
        if (addToChat)
        {
    ...
    public void drawBack(String kek)
    {
        GlStateManager.disableLighting();
        GlStateManager.disableFog();
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        this.mc.getTextureManager().bindTexture(new ResourceLocation(kek));
        this.drawScaledCustomSizeModalRect(0, 0, 0, 0, this.width, this.height, this.width, this.height, this.width, this.height);
    }
    public void drawZevs() {
    	 GlStateManager.disableLighting();
         GlStateManager.disableFog();
         GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
         this.drawBack("textures/misc/zevs2.jpg");
         this.drawScaledCustomSizeModalRect(0, 0, 0, 0, this.width, this.height, this.width, this.height, this.width, this.height);
